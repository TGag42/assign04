...
def keys_pressed(d_o_e=_root_window.dooneevent if _root_window is not None else None,
...
def remove_from_screen(x,
                       d_o_e=_root_window.dooneevent if _root_window is not None else None,
                       d_w=tkinter._tkinter.DONT_WAIT):
    _canvas.delete(x)
    if (d_o_e is None):
      return
