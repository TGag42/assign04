...
public class FindKLargestSortTimingExperiment extends TimingExperiment {
    ...
    public FindKLargestSortTimingExperiment(int count, int kMin, int kMax, double factor, int iterCount) {
    ...
    public static void main(String[] args) {
        FindKLargestSortTimingExperiment exp =
            new FindKLargestSortTimingExperiment(6, 1_000, 32_000, 2.0, 5);
        exp.run();
        exp.print();
    }
}
